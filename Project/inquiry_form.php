...
if(!empty($_SESSION['inquiry']) && isset($_POST['fill_inquiry'])){
...
<head>
  ...
  <section class="mt-5 py-5">
    <div class="container text-center mt-3 pt-5">
        <h2 class="font-weight-bold">Inquire</h2>
        <hr class="mx-auto"/>
    </div>
    <div class="mx-auto container">
        <form id="inquiry-form" method="POST" action="server/make_inquiry.php">
          <p style="color: red;"><?php if(isset($_GET['error'])){ echo $_GET['error']; } ?></p>
            <div class="form-group inquiry-small-element">
                <label>Name</label>
                <input type="text" class="form-control" id="inquiry-name" name="name" placeholder="Name" required/>
            </div>
            <div class="form-group inquiry-small-element">
                <label>Email</label>
                <input type="text" class="form-control" id="inquiry-email" name="email" placeholder="Email" required/>
            </div>
            <div class="form-group inquiry-small-element">
                <label>Phone</label>
                <input type="tel" class="form-control" id="inquiry-phone" name="phone" placeholder="Phone Number" required/>
            </div>
            <div class="form-group inquiry-small-element">
              <label>City</label>
              <input type="text" class="form-control" id="inquiry-city" name="city" placeholder="City" required/>
            </div>
            <div class="form-group inquiry-large-element">
              <label>Address</label>
              <input type="text" class="form-control" id="inquiry-address" name="address" placeholder="Address" required/>
            </div>
            <div class="form-group inquiry-small-element">
                <label>Move-In Date</label>
                <input type="text" class="form-control" id="move-in" name="move-in" placeholder="Move-In Date" required/>
            </div>
            <div class="form-group inquiry-small-element">
                <label>Nature of Inquiry</label>
                <input type="text" class="form-control" id="action" name="action" placeholder="Tour/Apply/Message" required/>
            </div>
            <div class="form-group inquiry-btn-container">
                <input type="submit" class="btn" id="sub_inquiry-btn" name="make_inquiry" value="Inquire"/>
            </div>
        </form>
    </div>
  </section>
